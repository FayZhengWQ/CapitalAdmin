 ...
 * Date:2019/7/1410:09
 */
public class JbzcAllMoneyTreeNode extends HashMap<String,Object> implements Serializable {
    ...
    private List<JbzcAllMoneyTreeNode> children;

    public JbzcAllMoneyTreeNode(String GOV_OUTLAY_CODE, String GOV_OUTLAY_NAME, String ALLMONEY, String ID, String MONEY1, String MONEY2, String MONEY3, String MONEY4, String MONEY5, String MONEY6, String MONEY7, String MONEY8, String MONEY9, String MONEY10, String MONEY11, String MONEY12, String MONEY13, String MONEY14, String MONEY15, String MONEY16) {
        super();
    ...
    public List<JbzcAllMoneyTreeNode> getChildren() {
        return children;
    }

    public void setChildren(List<JbzcAllMoneyTreeNode> children) {
