...
public class JjkmTreeNode extends HashMap<String,Object> implements Serializable {
    ...
    private List<JjkmTreeNode> children;

    public JjkmTreeNode() {
    }

    public JjkmTreeNode(String MONEY, String OUTLAY_CODE, String OUTLAY_NAME, String IS_LOWEST,String FISCAL,String FIS_PERD,String CO_CODE,String ID,String ISDISABLED,String SETID,String STAD_AMT,String XZ_STAD_AMT,String QCZ_STAD_AMT) {
        super();
        this.MONEY = MONEY;
    ...
    public List<JjkmTreeNode> getChildren() {
        return children;
    }

    public void setChildren(List<JjkmTreeNode> children) {
