...
import com.heitian.ssm.common.ImportCell;
...
public class ExcelImportor extends FileImportor {
    ...
    @Override
    public com.heitian.ssm.model.ImportResult getImportResult(File file, String fileName) throws FileImportException {
    ...
    private void setValue(Map<String, Object> maps, ImportCell importCell, Row row, StringBuilder sb, int line, int startRow) throws FileImportException {
        ...
        CellType rawCellType = CellType.BLANK;
        if (cell != null) {
            rawCellType = cell.getCellType();
        }
        if (rawCellType == CellType.BLANK ||
                cell == null ||
                rawCellType == CellType.STRING && StringUtils.isEmpty(cell.getStringCellValue())) {
            ...
            switch (cellType) {
                case INT:
                    if (rawCellType == CellType.STRING) {
                    ...
                    if (rawCellType == CellType.NUMERIC) {
