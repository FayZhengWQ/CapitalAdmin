        ...
        public  static  List<TreeNode>  TreeList(List<JczlBean> list){
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (list.get(i).getPARENT_GUID().equals("0")){
                    System.out.print(Integer.parseInt(list.get(i).getISBN_CODE())+"\n");
            ...
            System.out.print("长度"+cache.size()+"\n");

            List<TreeNode> trees =TreeBuilder.bulid(cache);
            System.out.print("长度"+trees.size()+"\n");
            return trees;
...
//                TreeFunctionNode functionNode = new TreeFunctionNode(list.get(i).getGUID(), list.get(i).getTITLE(),"0",list.get(i).getICON(),list.get(i).getROUTERLINK(),list.get(i).getLEVEL_NUM(),list.get(i).getISOPEN(),list.get(i).getISSELECTED(),list.get(i).getISDISABLEED());
                TreeFunctionNode functionNode = new TreeFunctionNode(list.get(i).getGUID(), list.get(i).getTITLE(),"0",false,list.get(i).getROUTERLINK(),list.get(i).getLEVEL_NUM(),list.get(i).getISOPEN(),list.get(i).getISSELECTED(),list.get(i).getISDISABLEED(),list.get(i).getVISIBLE(),list.get(i).getICON());
                ...
                for (int j = 0; j < list.size(); j++) {
                    ...
                    if (list.get(i).getPARENT_GUID().equals(list.get(j).getGUID())){
                        ...
                        TreeFunctionNode functionNode = new TreeFunctionNode(
                                ...
                                new TreeFunctionNode(list.get(j).getGUID(), list.get(j).getTITLE(), list.get(j).getPARENT_GUID(),false,list.get(j).getROUTERLINK(),list.get(j).getLEVEL_NUM(),list.get(j).getISOPEN(),list.get(j).getISSELECTED(),list.get(j).getISDISABLEED(),list.get(j).getVISIBLE(),list.get(j).getICON()) ,true,list.get(i).getROUTERLINK(),list.get(i).getLEVEL_NUM(),list.get(i).getISOPEN(),list.get(i).getISSELECTED(),list.get(i).getISDISABLEED(),list.get(i).getVISIBLE() ,list.get(i).getVISIBLE() );
                        cache.add(functionNode);
                    }
                }
            }
